    ...
    <div className='px-8 pb-14 md:px-0'>
      ...
      <div className='grid gap-8 grid-cols-auto mt-14'>
        {dummyTestimonial.map((testimonial, index) => (
          <div key={index} className='pb-6 text-sm text-left bg-white border rounded-lg shadow-[0px_4px_15px_0px] border-gray-500/30 overflow-hidden shadow-black/5'>
            ...
            <a href="#" className='px-5 text-gray-400 hover:text-blue-500 hover:underline'>Read more</a>
          </div>
        ))}
      </div>
    </div>
