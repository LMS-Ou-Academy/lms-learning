...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='flex flex-col items-start justify-between min-h-screen gap-8 p-4 pt-8 pb-0 md:p-7 md:pb-0'>
                ...
                {dashboardData.enrolledStudentsData.map((item, index)=>(
                  <tr className='border-b border-gray-500/20' key={index}>
                    ...
                    <td className='flex items-center px-2 py-3 space-x-3 md:px-4'>
                      <img src={item.student.imageUrl} alt="" className='rounded-full h-9 w-9' />
